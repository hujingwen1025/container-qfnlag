...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qfnlag.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qfnlag.containers.anotherwebservice.com/
...
```
git clone git@github.com:hujingwen1025/container-qfnlag.git
cd container-qfnlag
```
...
```
docker attach container-qfnlag
```
